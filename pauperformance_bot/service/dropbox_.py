...
class Dropbox:
    ...
    def get_imported_deckstats_deck_ids(
        self, deckstats_decks_path=DECKSTATS_DECKS_PATH
    ):
        return set(
    ...
    def get_imported_deckstats_deck_names(
        self, deckstats_decks_path=DECKSTATS_DECKS_PATH
    ):
        return set(
            file_metadata.path_display.rsplit("/", maxsplit=1)[1].split(">")[
                2
            ][
                :-4
            ]  # drop .txt
