from pauperformance_bot.constant.mtggoldfish import DECK_API_ENDPOINT, DECK_DOWNLOAD_API_ENDPOINT
...
class ListedMTGGoldfishDeck:
    def __init__(
        ...
        # Name of the archetype p12e_code.revision.player | Name of the set (set_code)
        self.name = name
    ...
    def download_tabletop_url(self):
        return f"{DECK_DOWNLOAD_API_ENDPOINT}/{self.deck_id}?output=mtggoldfish&amp;type=tabletop"

    @property
    def download_arena_url(self):
        return f"{DECK_DOWNLOAD_API_ENDPOINT}/{self.deck_id}?output=mtggoldfish&amp;type=arena"

    @property
    def download_mtgo_url(self):
        return f"{DECK_DOWNLOAD_API_ENDPOINT}/{self.deck_id}?output=mtggoldfish&amp;type=online"
