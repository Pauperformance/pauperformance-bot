...
DISCORD_CHANNEL_IMPORT_DECK_ID = get_credential(
    "DISCORD_CHANNEL_IMPORT_DECK_ID"
)
DISCORD_CHANNEL_WELCOME_ID = get_credential("DISCORD_CHANNEL_WELCOME_ID")
DISCORD_CHANNEL_MYR_LOG_ID = get_credential("DISCORD_CHANNEL_MYR_LOG_ID")
DISCORD_USER_MREVILEYE_ID = get_credential("DISCORD_USER_MREVILEYE_ID")
DISCORD_USER_SHIKA93_ID = get_credential("DISCORD_USER_SHIKA93_ID")
