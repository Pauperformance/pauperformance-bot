...
GOOGLE_OAUTH_ID_CLIENT = get_credential("GOOGLE_OAUTH_ID_CLIENT")
GOOGLE_OAUTH_CLIENT_SECRET = get_credential("GOOGLE_OAUTH_CLIENT_SECRET")
GOOGLE_OAUTH_REFRESH_TOKEN = get_credential("GOOGLE_OAUTH_REFRESH_TOKEN")
