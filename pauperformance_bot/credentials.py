...
MTGGOLDFISH_PAUPERFORMANCE_USERNAME = get_credential('MTGGOLDFISH_PAUPERFORMANCE_USERNAME')
MTGGOLDFISH_PAUPERFORMANCE_PASSWORD = get_credential('MTGGOLDFISH_PAUPERFORMANCE_PASSWORD')
